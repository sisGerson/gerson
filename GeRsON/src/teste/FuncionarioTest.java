...
public class FuncionarioTest {
	...
	public void testSetTipoFuncionario() {
		Funcionario f1 = new Funcionario();
		f1.setTipoFuncionario("secret??ria");
		assertEquals("secret??ria",f1.getTipoFuncionario());
	}
	...
	public void testSetCidadeFuncional() {
		Funcionario f1 = new Funcionario();
		f1.setCidadeFuncional("Bras??lia");
		assertEquals("Bras??lia",f1.getCidadeFuncional());
	}
