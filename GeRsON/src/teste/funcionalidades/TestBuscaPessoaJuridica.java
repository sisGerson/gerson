...
public class TestBuscaPessoaJuridica {
	...
	@Test
	//Verificando se a pesquisa � realmente feita(com o campo matricula)
	public void pesquisaPessoaJuridicaMatriculaTest() throws IOException, SAXException{
		...
		//isto � porque o resultado abre em outra janela
	...
	@Test
	//Confere que h� uma pessoa juridica com matricula 4321 catalogada no banco de dados
	public void verificaPessoaJuridica12345Test() throws IOException, SAXException{
		...
		//verifica se o texto da celula(linha 1, coluna 0) � "4321"
