...
public class TestsPedirFerias2 {
	...
	@Test
	//teste para verificar o link de pedir f√©rias
	public void testLinkPedirFerias() throws IOException, SAXException {
		...
		assertEquals(this.link.getText(), "Pedir FÈrias");
		this.link.click();
	...
	@Test
	//teste para verificar o formul√°rio e o resultado do pedido de f√©rias
	public void testFormResult() throws IOException, SAXException{
		...
		assertTrue(this.resp.getText().contains("VocÍ nao pode pedir fÈrias para essa data!"));
	}
	
	@Test
	//Teste para verificar situa√ß√£o das f√©rias
	public void testVerificarResult() throws IOException, SAXException {
		...
		assertEquals(this.link.getText(), "Verificar Pedido de FÈrias");
		this.link.click();
		
		this.resp = this.wc.getCurrentPage();
		assertTrue(this.resp.getText().contains("VocÍ n„o tem nem um pedido de fÈrias feito no momento!"));
	}
